...
df_full <- survey %>%
  ...
  left_join(exp_merged, by = "userid_matched")
```
...
write_rds(survey, here("data", "survey.rds"))
...
# full
write_csv(df_full, here("data", "df_full.csv"))
write_rds(df_full, here("data", "df_full.rds"))
```
